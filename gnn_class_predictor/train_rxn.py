...
def main():
    ...
    parser.add_argument('-data', type=str, default='./gnn_data',
    ...
    parser.add_argument('-n_classes', type=int, default=308,
    ...
    if args.test_model is not '':
        ...
        src_path = '%s/src_%s.txt' % (args.data, 'test')
    ...
    for data_type in ['train', 'val', 'test']:
        src_path = '%s/src_%s.txt' % (args.data, data_type)
        tgt_path = '%s/tgt_%s.txt' % (args.data, data_type)
