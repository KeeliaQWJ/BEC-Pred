...
# optional
model_path =  pkg_resources.resource_filename("rxnfp", "models/transformers/bert_pretrain")
print(model_path)
...
# optional
# train_model_path =  pkg_resources.resource_filename("rxnfp", "outputs/best_model")
...
# train_model_path =  pkg_resources.resource_filename("rxnfp", "models/transformers/bert_class_ec")
